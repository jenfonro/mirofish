...
# ``codex_cli_rs``: originator prefix and the client suffix are both the
# name the kernel gives it at initialize (``mirasim`` on a live 0.0.367
# session).  Since 0.0.303 Codex is no longer bundled, so the version floats
